	...
	<body>
		...
		<section id="left-side">
			...
			<div class="content">
				...
				<h1 class="" style="font-family: 'Pacifico', cursive; font-size: 64px;">acmn</h1>
		...
		<section id="right-side" class="hide-right">
			...
			<div class="content">
				...
				<p>Hi, I'm Phly, your new template ready to use. Handmade, precisely built with the famous Bootstrap Framework. Bonjour, je suis Phly, votre nouveau template prêt à l'emploi. Fait main, construit avec précision grâce au célèbre Framework Bootstrap. </p>
                    ...
                    <div class="col-xs-12 col-sm-4 col-lg-4">
                        <div class="team-col">
                            ...
                            <div class="team-description">
                                ...
                                <h5>Komfort</h5>
                                <h6>Steuerung und Automatisierung von Licht, Sound und Informationssystemen</h6>
                    ...
                    <div class="col-xs-12 col-sm-4 col-lg-4">
                        <div class="team-col">
                            ...
                            <div class="team-col-image">
                                ...
                                <img class="img-responsive" src="img/service-2.jpg" alt="">
                            ...
                            <div class="team-description">
                                ...
                                <h5>Sicherheit</h5>
                                <h6>Integration von Überwachungskameras, Bewegungssensoren und Rauchmeldern</h6>
                    ...
                    <div class="col-xs-12 col-sm-4 col-lg-4">
                        <div class="team-col">
                            ...
                            <div class="team-col-image">
                                ...
                                <img class="img-responsive" src="img/service-3.jpg" alt="">
                            ...
                            <div class="team-description">
                                ...
                                <h5>Effizienz</h5>
                                <h6>Intelligente Steuerung der Heiztechnik mit Anwesenheitserkennung</h6>
				...
				<div class="info-contact row">
                    ...
                    <div class="col-xs-12 col-sm-4 col-lg-4 item-map">
                        <div class="contact-item"><i class="icon ion-ios-telephone"></i>
                            <p>Telefon: 07181 492 107 0
                                <br>Telefax: 07181 492 107 9</p>
                        </div>
                    </div>
                    ...
                    <div class="col-xs-12 col-sm-4 col-lg-4 item-map">
                        <div class="contact-item"><i class="icon ion-ios-email"></i>
                            <p><a href="mailto:info@acmn.com">info@acmn.de</a>
