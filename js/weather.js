...
Weather.getCurrent = function (city, callback) {
  var url = "http://openweathermap.org/data/2.1/find/city?APPID=c072e0533645cea6283bbddf231d191e&q=" + encodeURIComponent(city) + "&cnt=1";
...
Weather.getForecast = function (city, callback) {
  var url = "http://openweathermap.org/data/2.1/forecast/city?APPID=c072e0533645cea6283bbddf231d191e&q=" + encodeURIComponent(city) + "&cnt=1";
